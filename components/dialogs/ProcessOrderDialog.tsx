...
import { Loader2, Calculator, UserPlus, Trash2, Wrench, Package, List as ListIcon } from "lucide-react";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function ProcessOrderDialog({
  ...
  // Lead Mechanic for Kanban display
...
// Helper component for item input
      ...
      <div className="w-[70px]">
        <div className="relative">
          <Input
            type="number"
            value={item.qty}
            onChange={(e) => onUpdate(index, { qty: e.target.value as unknown as number })}
      ...
      <div className="w-[140px]">
        <div className="relative">
          ...
          <Input
            ...
            placeholder="0"
            value={item.price}
            onChange={(e) => onUpdate(index, { price: e.target.value as unknown as number })}
