...
export default async function EmployeeDashboardPage() {
  ...
  if (session.user.role !== "EMPLOYEE" || !session.user.employeeId) {
    // If admin tries to access, maybe redirect to admin or show error?
    // But for now let's just allow if they have an employeeId attached (some admins are also employees)
